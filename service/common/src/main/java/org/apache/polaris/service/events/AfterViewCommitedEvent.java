...
public class AfterViewCommitedEvent extends PolarisEvent {
     ...
     */
    public AfterViewCommitedEvent(TableIdentifier identifier, ViewMetadata base, ViewMetadata metadata) {
